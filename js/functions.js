document.addEventListener("DOMContentLoaded", function() {
  ...
  function renderTodos() {
    ...
    for (var i = 0; i < todos.length; i++) {
      ...
      document.getElementById("todo-list").innerHTML += '<li class="' + todoClass + ' d-flex align-items-center"><span class="todo-text">' + todoText + '</span><div class="btn-group ms-auto"><button type="button" class="btn btn-success done-todo">' + todoButton + '</button><button class="btn btn-danger delete-todo">Delete</button></div></li>';
    }
  }
